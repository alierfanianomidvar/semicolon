...
package com.unipd.semicolon.base.resource;
...
public final class Actions {
	...
	/**
	 * The reading of an employee
	 */
	public static final String READ_EMPLOYEE = "READ_EMPLOYEE";

	/**
	 * The update of an employee
	 */
	public static final String UPDATE_EMPLOYEE = "UPDATE_EMPLOYEE";

	/**
	 * The deletion of an employee
	 */
	...
	/**
	 * The listing of all the employees
	 */
