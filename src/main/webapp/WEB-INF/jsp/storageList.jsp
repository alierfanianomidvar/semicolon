...
<head>
    <style>
        <%@include  file="../../css/storageListJsp.css" %>
    </style>
    <meta charset="UTF-8">
    ...
    <div class="row no-gutters">
        ...
        <div class="col-12 col-md-9" style="margin-left: 2%">
            <div class="row" style="margin-top: 2%">
                <div class="col-lg-12">
                    <h4 style="margin-bottom: 1%; font-weight: bold;">Storage</h4>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col">
                    <div test='${not empty storage && !message.error}'>
...
<script src="../../js/storageList.js" type=""></script>
